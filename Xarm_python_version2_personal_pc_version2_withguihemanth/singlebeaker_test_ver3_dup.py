...
#import OT2_Test_duplicate.heyyounogui as ot2file
    ...
    def run(self, num_samples = int, inlet_flow_rate = int, inlet_flow_time = int, inlet_measurement_channel = int, 
        ...
        try:
            ...
            for i in range(int(num_samples)):
                ...
                #ot2file.runfile.add_volumes(inhibitor1= str, vol1= int, inhibitor2= str, vol2= int)
...
if __name__ == '__main__':
    ...
    robot_main.run(num_samples = 1, inlet_flow_rate = 8, inlet_flow_time = 60, inlet_measurement_channel = 1,
                   outlet_flow_rate = 25, outlet_flow_time = 80, outlet_measurement_channel = 3, 
                   inhibitor1 = 'Rashid', vol1 = 30 , inhibitor2 = 'Hemanth', vol2 = 40)
# RobotMain.pprint('xArm-Python-SDK Version:{}'.format(version.__version__))
# arm = XArmAPI('192.168.1.178', baud_checkset=False)
# robot_main = RobotMain(arm)
